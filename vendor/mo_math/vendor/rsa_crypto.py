# SNAGGED FROM https://gist.github.com/dennislwy/0194036234445776d48ad2fb594457d4
# ALSO FOUND AT https://stackoverflow.com/a/42856051
...
from pyLibrary.convert import base642bytes, json2value
...
def sign(message, priv_key, hashAlg="SHA-256"):
    ...
    bytes = value2json(message).encode('utf8')
    digest.update(bytes)
